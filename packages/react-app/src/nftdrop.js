  ...
  async function nftId() {
    try {
      ...
      for (var i = 0; i < amount; i++) {
        const id = await contract.methods.tokenOfOwnerByIndex(i);
        list.push(id);
      }
      console.log(amount);
      return list;
        ...
        <TopHeader>
          <FloatingDiv>
            <FloatingInnerDiv>
              ...
              You will be soon able to stake it on Unifarm and earn upto 250%
              APY.
            </FloatingInnerDiv>
          ...
          <AccordionDiv allowZeroExpanded>
            <AccordionItemDiv key={0}>
              ...
              <AccordionItemPanelDiv>
                ...
                its fluid nature is now controlled and censored by governments
                and corporates. But nowadays the internet is in the middle of a
                revolution: centralized proprietary services are being replaced
                with decentralized solutions and monolithic services replaced
                with peer-to-peer algorithmic systems. Here comes the
                Decentralized Hosting solution, which can revolutionize how
                traditional web hosting services work. With peer-to-peer content
                delivery networks, hosting a web application now can be easily
                done without a centralized system. With the advent of Web3.0
                technologies, it is now more than ever important to decentralize
                frontend applications without a centralized entity controlling
                their hosted site and takedown at any moment.
              </AccordionItemPanelDiv>
            </AccordionItemDiv>
            <AccordionItemDiv key={1}>
              ...
              <AccordionItemPanelDiv>
                ...
                organizations and repositories like structure. ArGo also
                provides DNS configuration for any deployment with an intuitive
                User Experience. With ArGo, users no longer have to depend on
                subscription plans of cloud provider giants, enjoy fast
                deployment via pre-rendered front-end web pages supported by
                multiple Jamstacks, and scale seamlessly without any monthly
                recurring fees. This space is 100% auditable and verifiable
                because all the deployment will be logged in the blockchain with
            ...
            <AccordionItemDiv key={2}>
              ...
              <AccordionItemPanelDiv>
                ...
                . On the app, you can just sign up with GitHub and start
                deploying your app directly from the GitHub repository. Apart
                from the web app, we are also working on CLI for ArGo so that
                user can directly deploy their web app from their local system.
              </AccordionItemPanelDiv>
            </AccordionItemDiv>
            <AccordionItemDiv key={3}>
              ...
              <AccordionItemPanelDiv>
                ...
                . Anyone can use it by signing up with GitHub and start
                deploying your app directly from the GitHub repository.
              </AccordionItemPanelDiv>
            </AccordionItemDiv>
            <AccordionItemDiv key={4}>
              ...
              <AccordionItemPanelDiv>
                ...
                experience of our users. We are building our v2 which will
                improve the efficiency and stability of the entire ecosystem.
              </AccordionItemPanelDiv>
            </AccordionItemDiv>
